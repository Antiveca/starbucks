const searchEl = document.querySelector(".search"); //document=html자체
...
spyEls.forEach(function(spyEl) {
  new ScrollMagic
  .Scene({
    triggerElement: spyEl, //뷰포트에 보여짐 여부를 감시할 요소를 지정
    triggerHook: 0.8, //뷰포트의 0.8지점에 걸리면 실행됨(뷰퓨트 가장 위가 0, 가장 아래가 1)
  })
